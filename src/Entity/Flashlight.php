...
#[ORM\Entity(repositoryClass: FlashlightRepository::class)]
#[UniqueEntity(fields: 'email', message: 'Ten adres email został już wykorzystany.')]
class Flashlight
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'flashlights')]
